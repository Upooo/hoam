...
@app.on_message(filters.command("pl") & filters.group & ~filters.user(BANNED_USERS))
...
@app.on_message(filters.command("unpl") & filters.group & ~filters.user(BANNED_USERS))
...
@app.on_message(filters.command("listpl") & filters.group & ~filters.user(BANNED_USERS))
...
@app.on_message(filters.command("clearpl") & filters.group & ~filters.user(BANNED_USERS))
